...
def downgrade() -> None:
    ...
    op.drop_index('ix_books_isbn_trgm', table_name='books', postgresql_using='gin', postgresql_ops={'isbn': 'gin_trgm_ops'})
    op.drop_index('ix_books_genre_trgm', table_name='books', postgresql_using='gin', postgresql_ops={'genre': 'gin_trgm_ops'})
    op.drop_index('ix_books_description_trgm', table_name='books', postgresql_using='gin', postgresql_ops={'description': 'gin_trgm_ops'})
