...
async def search_books_natural_language(
    ...
    logger.info(f"━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    logger.info(f"[AI Search Started] Query: '{search_data.query}' | Sort: {sort_order}")
    logger.info(f"━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    ...
    if sql_result["success"]:
        ...
        logger.warning(f"[Reason] {sql_result.get('fallback_reason', 'unknown')}: {sql_result.get('error', '')}")
        logger.warning("[Fallback] Switching to filter extraction method...")
    ...
    try:
        ...
        if author or genre or keywords or published_year:
            ...
            logger.info(f"[Fallback Step 2] Author: {author}, Genre: {genre}, Year: {published_year}")
        else:
            logger.info(f"[Fallback Step 2] Gemini returned no specific filters, using raw query")
        
        logger.info(f"[Fallback Step 3] Building ILIKE query...")
        logger.info(f"[Fallback Step 3] Keywords: {keywords if keywords else search_data.query}")
        ...
        logger.info(f"[Result] Method: FILTER EXTRACTION | Found: {len(books)} books | Fallback Reason: {sql_result.get('fallback_reason', 'unknown')}")
        logger.info(f"━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
